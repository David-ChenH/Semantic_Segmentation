...
def test():
    ...
    if not os.path.exists("./ADEChallengeData2016/prediction_segnet"):
        os.makedirs("./ADEChallengeData2016/prediction_segnet")
    ...
    all_mIoU = []
    class_number = 150
    my_model = keras.models.load_model("./small_ade_Segnet_model.h5")
    count = 1784
    for i in range(10):
        ...
        cv2.imwrite("./ADEChallengeData2016/prediction_segnet/pre_" + str(i) + ".jpg", color_predict)
        cv2.imwrite("./ADEChallengeData2016/prediction_segnet/ann_" + str(i) + ".jpg", color_annotation)
        count += 1
