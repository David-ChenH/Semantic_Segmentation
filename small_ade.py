...
def FCN8(class_num, input_height=224, input_width=224):
    ...
    net = Conv2D(filters=64, kernel_size=(3, 3), activation="relu", padding="same", name="layer1_conv1", data_format="channels_last")(input_img)
    net = Conv2D(filters=64, kernel_size=(3, 3), activation="relu", padding="same", name="layer1_conv2", data_format="channels_last")(net)
    net = MaxPooling2D((2, 2), strides=(2, 2), name="layer1_pool", data_format="channels_last")(net)
    conv1 = net
    
    net = Conv2D(filters=128, kernel_size=(3, 3), activation="relu", padding="same", name="layer2_conv1", data_format="channels_last")(net)
    net = Conv2D(filters=128, kernel_size=(3, 3), activation="relu", padding="same", name="layer2_conv2", data_format="channels_last")(net)
    net = MaxPooling2D((2, 2), strides=(2, 2), name="layer2_pool", data_format="channels_last")(net)
    conv2 = net

    net = Conv2D(filters=256, kernel_size=(3, 3), activation="relu", padding="same", name="layer3_conv1", data_format="channels_last")(net)
    net = Conv2D(filters=256, kernel_size=(3, 3), activation="relu", padding="same", name="layer3_conv2", data_format="channels_last")(net)
    net = Conv2D(filters=256, kernel_size=(3, 3), activation="relu", padding="same", name="layer3_conv3", data_format="channels_last")(net)
    net = MaxPooling2D((2, 2), strides=(2, 2), name="layer3_pool", data_format="channels_last")(net)
    pool3 = net

    net = Conv2D(filters=512, kernel_size=(3, 3), activation="relu", padding="same", name="layer4_conv1", data_format="channels_last")(net)
    net = Conv2D(filters=512, kernel_size=(3, 3), activation="relu", padding="same", name="layer4_conv2", data_format="channels_last")(net)
    net = Conv2D(filters=512, kernel_size=(3, 3), activation="relu", padding="same", name="layer4_conv3", data_format="channels_last")(net)
    net = MaxPooling2D((2, 2), strides=(2, 2), name="layer4_pool", data_format="channels_last")(net)
    pool4 = net
    
    net = Conv2D(filters=512, kernel_size=(3, 3), activation="relu", padding="same", name="layer5_conv1", data_format="channels_last")(net)
    net = Conv2D(filters=512, kernel_size=(3, 3), activation="relu", padding="same", name="layer5_conv2", data_format="channels_last")(net)
    net = Conv2D(filters=512, kernel_size=(3, 3), activation="relu", padding="same", name="layer5_conv3", data_format="channels_last")(net)
    ...
    conv7_four_time = Conv2DTranspose(class_num, kernel_size=(4, 4), strides=(4, 4), use_bias=False, data_format="channels_last")(net)

    pool_four_time_1 = (Conv2D(class_num, (1, 1), activation="relu", padding="same", name="pool_four_time_1", data_format="channels_last"))(pool4)
    pool_four_time_2 = (Conv2DTranspose(class_num, kernel_size=(2, 2), strides=(2, 2), use_bias=False, data_format="channels_last"))(pool_four_time_1)

    pool_three_time_1 = (Conv2D(class_num, (1, 1), activation="relu", padding="same", name="pool_three_time_1", data_format="channels_last"))(pool3)

    out = Add(name="add")([pool_four_time_2, pool_three_time_1, conv7_four_time])
    out = Conv2DTranspose(class_num, kernel_size=(8, 8), strides=(8, 8), use_bias=False, data_format="channels_last")(out)
...
model = FCN8(class_num=151,input_height=224,input_width=224)
model.summary()

ticks = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()) 
main_path = "./"
log_dir_name = "small_ade_FCN_log_%s" % ticks
log_dir_path = main_path+log_dir_name

checkpoint_dir_name = "small_ade_FCN_saved_model_%s" % ticks
...
model.save('small_ade_FCN_model.h5')